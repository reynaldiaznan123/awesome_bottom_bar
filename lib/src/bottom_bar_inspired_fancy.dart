        ...
        if (widget.animated)
          AnimatedBuilder(
            ...
            builder: (context, child) {
              return buildItemContent(item, active ? widget.colorSelected : widget.color, padding, isSelected);
            },
          )
        else
          buildItemContent(item, active ? widget.colorSelected : widget.color, padding, isSelected),
        Positioned(
          left: 0,
          right: 0,
          bottom: padBottom - 8,
